...
const UserMenu = ({}) => {
    ...
    return (
        <div className="relative">
            {user ? (
                <div onClick={toggleOpen} className='rounded-full hover:shadow-lg cursor-pointer transition duration-300'>
                    <Avatar src={avatar_url} />
                </div>
            ) : null}
            {userModal.isOpen && (
                <div className='absolute w-[60vw] md:w-[30vw] lg:w-[26vw] xl:w-[19vw] bg-white border-black
                overflow-hidden right-0 top-12 text-sm rounded-xl shadow-lg'>
